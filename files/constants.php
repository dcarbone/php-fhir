...
define('PHPFHIR_FHIR_VALIDATION_JAR', PHPFHIR_BIN_DIR . DIRECTORY_SEPARATOR . 'validator_cli.jar');
...
define('PHPFHIR_TEST_TYPE_BASE', 'base');
define('PHPFHIR_TEST_TYPE_UNIT', 'unit');
define('PHPFHIR_TEST_TYPE_INTEGRATION', 'integration');
define('PHPFHIR_TESTS_NAMESPACE_BASE', 'PHPFHIRTests');
define('PHPFHIR_TESTS_NAMESPACE_UNIT', PHPFHIR_TESTS_NAMESPACE_BASE . '\\Unit');
define('PHPFHIR_TESTS_NAMESPACE_INTEGRATION', PHPFHIR_TESTS_NAMESPACE_BASE . '\\Integration');
