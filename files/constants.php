...
const PHPFHIR_CLASSNAME_API_CLIENT = 'PHPFHIRApiClient';
const PHPFHIR_CLASSNAME_API_CLIENT_REQUEST = 'PHPFHIRApiClientRequest';
const PHPFHIR_CLASSNAME_API_CLIENT_RESPONSE = 'PHPFHIRApiClientResponse';
...
// Version Constants
const PHPFHIR_CLASSNAME_VERSION_TYPEMAP = 'PHPFHIRVersionTypeMap';
const PHPFHIR_CLASSNAME_VERSION_CONSTANTS = 'PHPFHIRVersionConstants';
