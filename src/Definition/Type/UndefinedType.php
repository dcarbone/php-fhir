...
/**
 * This type is used whenever another type has a property that references a type that was not defined in the FHIR
 * schema
 *
...
class UndefinedType extends AbstractType
{
     ...
     * @return \DCarbone\PHPFHIR\Definition\Type\AbstractType|void
     */
