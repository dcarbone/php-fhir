...
<?php echo $documentation; ?>
     ...
     * @return static
     */
    public function <?php echo $isCollection ? 'add' : 'set'; ?><?php echo ucfirst($propertyName); ?>(<?php echo TypeHintUtils::propertyTypeHint($config, $property, true); ?> $<?php echo $propertyName; ?> = null): object
    {
