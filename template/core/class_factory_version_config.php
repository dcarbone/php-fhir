...

{
     ...
     * @param null|array|<?php echo $versionConfigInterface->getFullyQualifiedName(true); ?> $config Version configuration
     */
    ...
    /**
     * @return null|<?php echo $versionConfigInterface->getFullyQualifiedName(true); ?>
