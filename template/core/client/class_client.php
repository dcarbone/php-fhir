...

{
    ...
    /** @var <?php echo $confClass->getFullyQualifiedName(true); ?> */
     ...
     *
     * @return <?php echo $confClass->getFullyQualifiedName(true); ?>
    ...
    /**
     * @param string|<?php echo $htMethodEnum->getFullyQualifiedName(true); ?> $method
     * @param string $path
